...
if(!$success) {json_echo(array('status'=>1, message=>'Error on backend.')); http_response_code(400);}
else		  {json_echo(array('status'=>0, message=>'Photo sent.')); http_response_code(200);}
?>
